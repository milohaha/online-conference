...
ot.TextOperation = (function () {
  ...
  TextOperation.prototype.compose = function (operation2) {
    ...
    var ops1 = operation1.ops; var ops2 = operation2.ops // for fast access
    var i1 = 0; var i2 = 0 // current index into ops1 respectively ops2
    var op1 = ops1[i1++]; var op2 = ops2[i2++] // current ops
    while (true) {
  ...
  TextOperation.prototype.shouldBeComposedWith = function (other) {
    ...
    var startA = getStartIndex(this); var startB = getStartIndex(other)
    var simpleA = getSimpleOp(this); var simpleB = getSimpleOp(other)
  ...
  TextOperation.transform = function (operation1, operation2) {
    ...
    var ops1 = operation1.ops; var ops2 = operation2.ops
    var i1 = 0; var i2 = 0
    var op1 = ops1[i1++]; var op2 = ops2[i2++]
    while (true) {
...
ot.EditorSocketIOServer = (function () {
