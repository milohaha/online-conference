...
(function () {
  ...
  fabric.util.object.extend(fabric.StaticCanvas.prototype, {
    ...
    _renderBackgroundOrOverlay: function (ctx, property) {
      var fill = this[property + 'Color']; var object = this[property + 'Image']
      var v = this.viewportTransform; var needsVpt = this[property + 'Vpt']
      if (!fill && !object) {
        return
      }
      if (fill || object) {
    ...
    /** @lends fabric.EraserBrush.prototype */ {
      ...
      */
      ...
      _finalizeAndAddPath: function () {
        var ctx = this.canvas.contextTop; var canvas = this.canvas
        ctx.closePath()
        if (this.decimate) {
