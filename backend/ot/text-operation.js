...
ot.TextOperation = (function () {
  ...
  TextOperation.prototype.compose = function (operation2) {
    ...
    const ops1 = operation1.ops; const ops2 = operation2.ops // for fast access
    let i1 = 0; let i2 = 0 // current index into ops1 respectively ops2
    let op1 = ops1[i1++]; let op2 = ops2[i2++] // current ops
    while (true) {
  ...
  TextOperation.prototype.shouldBeComposedWith = function (other) {
    ...
    const startA = getStartIndex(this); const startB = getStartIndex(other)
    const simpleA = getSimpleOp(this); const simpleB = getSimpleOp(other)
  ...
  TextOperation.transform = function (operation1, operation2) {
    ...
    const ops1 = operation1.ops; const ops2 = operation2.ops
    let i1 = 0; let i2 = 0
    let op1 = ops1[i1++]; let op2 = ops2[i2++]
    while (true) {
